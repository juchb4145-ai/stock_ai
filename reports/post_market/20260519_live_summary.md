# 2026-05-19 Post-Market Condition Review (live)
...
| sector_code | 오락문화 | 13 | 3 | 0 | missing |
...
| sector_name | 오락/문화 | 13 | 3 | 0 | missing |
...
| sector_index_code | KOSPI:오락문화 | 7 | 1 | 0 | missing |
| sector_index_code | KOSDAQ:오락문화 | 6 | 2 | 0 | missing |
| sector_index_code | KOSPI:제약 | 6 | 2 | 3 | +21.59% |
| sector_index_code | KOSPI:화학 | 6 | 2 | 0 | missing |
| sector_index_code | KOSPI:유통 | 5 | 2 | 0 | +1.91% |
| sector_index_code | KOSDAQ:금속 | 4 | 2 | 0 | missing |
...
| primary_theme | 컨텐츠_음원 | 6 | 2 | 0 | missing |
...
| primary_theme | 기계_공작기계 | 2 | 1 | 0 | missing |
| primary_theme | 무선충전기관련주 | 2 | 1 | 0 | +0.00% |
| primary_theme | 반도체_전공정장비 | 2 | 1 | 0 | missing |
| primary_theme | 배합사료 | 2 | 1 | 0 | +1.53% |
| primary_theme | 비철금속주 | 2 | 1 | 0 | missing |
| primary_theme | PCB(인쇄회로기판) | 1 | 1 | 0 | missing |
| primary_theme | 바이오_줄기세포치료제 | 1 | 1 | 0 | missing |
| primary_theme | 반도체_생산 | 1 | 1 | 1 | +2715.00% |
| primary_theme | 백화점 | 1 | 1 | 0 | missing |
...
| theme_names | 컨텐츠_음원;컨텐츠_한류 | 6 | 2 | 0 | missing |
...
| theme_names | 바이오_진단/백신;코스닥_라이징스타;코스닥_히든챔피언 | 3 | 1 | 0 | missing |
| theme_names | 방위산업;조선_Eco선;조선_해양플랜트 | 3 | 1 | 0 | +0.03% |
| theme_names | 기계_공작기계 | 2 | 1 | 0 | missing |
| theme_names | 무선충전기관련주 | 2 | 1 | 0 | +0.00% |
| theme_names | 반도체_전공정장비;코스닥_라이징스타 | 2 | 1 | 0 | missing |
| theme_names | 배합사료 | 2 | 1 | 0 | +1.53% |
| theme_names | 비철금속주 | 2 | 1 | 0 | missing |
| theme_names | PCB(인쇄회로기판) | 1 | 1 | 0 | missing |
| theme_names | 건설_해외건설;합성수지 | 1 | 1 | 0 | missing |
| theme_names | 바이오_줄기세포치료제 | 1 | 1 | 0 | missing |
| theme_names | 반도체_생산 | 1 | 1 | 1 | +2715.00% |
| theme_names | 백화점 | 1 | 1 | 0 | missing |
...
| theme_member_count | 11 | 2 | 1 | 0 | missing |
| theme_member_count | 12 | 2 | 1 | 0 | missing |
| theme_member_count | 13 | 1 | 1 | 0 | missing |
